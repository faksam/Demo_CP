...
function Calendar_constructor(element, overrides) {
	...
	function initialRender() {
		...
		content = $("<div id='fc-view-container' class='fc-view-container'/>").prependTo(element);
	...
	function render() {
		...
		if (sections) {
			el = $("<div class='fc-toolbar'/>")
				...
				//.append('<br><div class="row"><button class="btn btn-info active">Calendar</button><button class="btn btn-info">List</button></div>');
